...
**Status atual:** v0.1.0 LIVE em VPS compartilhada (com Langfuse). Limitacao: VPS compartilhada nao e ambiente de producao para dados de saude.
...
| Caddy TLS auto | Let's Encrypt; subdominio proprio (ex: cannabr.org) | Pronto |
...
|---|---|---|
| v0.1.0 (atual) | Simulacao | MCP Tools 1-3, simulacao local, cadastro/gestao de membros, dispensacao com aprovacao, rastreabilidade de lote, trilha de auditoria imutavel |
| v0.2 | Fase 1 | Multi-tenant + onboarding self-serve |
| v0.3 | Fase 1 + 2 | VPS dedicada + LGPD hardening (RBAC/TOTP/consent/crypto-deletion) |
