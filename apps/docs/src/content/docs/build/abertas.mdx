...
**Gap:** canna-br esta em VPS compartilhada (com Langfuse). Dados de saude (LGPD Art. 5 II) em ambiente compartilhado nao e producao viavel.
...
**Hoje:** SurrealDB fonsecagabriel esta na VPS compartilhada interna para uso interno da fleet de agentes — nao para canna-br producao. Canna-oss usa PostgreSQL 16.
