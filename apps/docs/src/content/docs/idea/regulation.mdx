...
Hoje: 400+ associações mapeadas no Brasil; SAM ~315 endereçáveis operam sob HC judicial, com compliance informal. RDC 1.014 muda o paradigma para operação legitimada com ANVISA como autoridade fiscalizadora primária.
