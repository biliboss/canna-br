...
Sub-agent G smoke 2026-06-08 — OWUI v0.9.6 + Postgres 16 + Redis 7 docker-compose stack. Cold start 44s, 3 GB RAM steady. 9 screenshots em [`ops/openwebui/smoke/`](https://github.com/canna-oss/canna-oss/tree/main/ops/openwebui/smoke):
