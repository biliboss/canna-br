...
- <strong>Hosted</strong>: dados rodam em <a href="https://cannabr.org">cannabr.org</a> — instância oficial multi-tenant com schema PostgreSQL isolado por associação. Infraestrutura na Hetzner (Alemanha), backups diários cifrados.
